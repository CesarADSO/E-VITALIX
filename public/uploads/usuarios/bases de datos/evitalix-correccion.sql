...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 21, 2025 at 09:28 PM
...
ALTER TABLE `especialistas`
  ...
  ADD KEY `fk_especialistas_usuario` (`id_usuario`);
...
ALTER TABLE `pacientes`
  ...
  ADD KEY `fk_pacientes_usuario` (`id_usuario`);
...
--
ALTER TABLE `citas`
  ADD CONSTRAINT `citas_ibfk_1` FOREIGN KEY (`id_pacientes`) REFERENCES `pacientes` (`id`),
...
--
ALTER TABLE `consultorios_medicos`
  ADD CONSTRAINT `consultorios_medicos_ibfk_1` FOREIGN KEY (`id_especialista`) REFERENCES `usuarios` (`id`),
...
--
ALTER TABLE `disponibilidad_medico`
  ADD CONSTRAINT `disponibilidad_medico_ibfk_1` FOREIGN KEY (`id_medico`) REFERENCES `usuarios` (`id`);

--
-- Constraints for table `especialistas`
--
ALTER TABLE `especialistas`
  ADD CONSTRAINT `fk_especialistas_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`);

--
-- Constraints for table `formulacion_medicamentos`
--
ALTER TABLE `formulacion_medicamentos`
  ADD CONSTRAINT `formulacion_medicamentos_ibfk_1` FOREIGN KEY (`id_paciente`) REFERENCES `pacientes` (`id`),
  ADD CONSTRAINT `formulacion_medicamentos_ibfk_2` FOREIGN KEY (`id_especialista`) REFERENCES `especialistas` (`id`);

--
-- Constraints for table `historiales_clinicos`
--
ALTER TABLE `historiales_clinicos`
  ADD CONSTRAINT `historiales_clinicos_ibfk_1` FOREIGN KEY (`id_paciente`) REFERENCES `pacientes` (`id`),
  ADD CONSTRAINT `historiales_clinicos_ibfk_2` FOREIGN KEY (`id_especialista`) REFERENCES `especialistas` (`id`);

--
-- Constraints for table `pacientes`
--
ALTER TABLE `pacientes`
  ADD CONSTRAINT `fk_pacientes_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`),
  ADD CONSTRAINT `pacientes_ibfk_1` FOREIGN KEY (`id_tipo_documento`) REFERENCES `tipos_documento` (`id`);

--
-- Constraints for table `pagos`
--
ALTER TABLE `pagos`
  ADD CONSTRAINT `pagos_ibfk_1` FOREIGN KEY (`id_paciente`) REFERENCES `usuarios` (`id`);
COMMIT;
