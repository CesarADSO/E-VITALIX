...
class Slot
{
    ...
    {
        try {
            $consulta = "SELECT servicios.nombre AS nombre_servicio, especialistas.foto AS foto_especialista, especialistas.nombres AS nombre_especialista, especialistas.apellidos AS apellidos_especialista, agenda_slot.estado_slot, agenda_slot.fecha, agenda_slot.hora_inicio, agenda_slot.hora_fin FROM agenda_slot INNER JOIN especialistas ON agenda_slot.id_especialista = especialistas.id INNER JOIN especialidades ON especialistas.id_especialidad = especialidades.id INNER JOIN servicios ON servicios.id_especialidad = especialidades.id WHERE agenda_slot.id_consultorio = :id_consultorio AND especialidades.id = :id_especialidad AND servicios.id = :id_servicio AND agenda_slot.fecha >= CURDATE()";
