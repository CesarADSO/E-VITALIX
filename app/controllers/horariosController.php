...
function registrarHorario()
{
    ...
    if (empty($especialista) || empty($consultorio) || empty($diaSemana) || empty($capacidadMaxima) || empty($horaInicio) || empty($horaFin) || empty($inicioDescanso) || empty($finDescanso)) {
    ...
    $resultado = $objHorario->registrar();
