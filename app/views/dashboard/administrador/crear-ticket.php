            ...
            <div class="col-lg-10 col-md-9 main-content">
                ...
                <div id="dashboardSection">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <a href="<?= BASE_URL ?>/admin/mis-tickets" class="btn btn-link text-primary p-0" style="text-decoration: none; font-size: 14px;">← Todos</a>
                        <a href="<?= BASE_URL ?>/admin/mis-tickets" class="btn btn-primary btn-sm btn-añadir-volver"><i class="bi bi-arrow-left"></i> VOLVER</a>
                    </div>
