              ...
              <div class="row">
                     ...
                     <div class="col-lg-10 col-md-9 main-content">
                            ...
                            <div id="perfilSection" style="display:block;">
                                   ...
                                   <?php include_once __DIR__ . '/../../layouts/topbar_administrador.php'; ?>
                                          ...
                                          <div class="col-md-4">
                                                 <div class="cont-form-foto bg-white rounded shadow-sm p-4 text-center mb-4">
                                                        ...
                                                        <form id="formFotoPerfil"
                                                               ...
                                                               <label for="fotoAdmin" class="user-avatar avatar-editable"
                                                 ...
                                                 <div class="bg-white rounded shadow-sm p-4 d-none d-md-block">
                                                        ...
                                                        <div style="font-size:14px;margin-bottom:10px;">
                                                               ...
                                                               <span style="color:var(--color-primario);">
                                                                      <?= $perfil['admin_nombre'] ?>, <?= $perfil['apellidos'] ?>
                                                               </span>
                                                        </div>
              ...
              document.getElementById("fotoAdmin").addEventListener("change", function() {
                     ...
                     if (this.files && this.files[0]) {
                            ...
                            reader.onload = function(e) {
                                   document.querySelector(".adminPerfilImg").src = e.target.result;
                            };
                            reader.readAsDataURL(this.files[0]);

                            document.getElementById("formFotoPerfilAdmin").submit();
                     }
