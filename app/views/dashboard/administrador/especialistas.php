                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item text-danger" href="<?= BASE_URL ?>/admin/eliminar-especialista?accion=eliminar&id=<?= $especialista['id'] ?>&idUsuario=<?= $especialista['id_usuario'] ?>&idDisponibilidad=<?= $especialista['id_disponibilidad'] ?>"><i class="bi bi-trash"></i> Eliminar</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
