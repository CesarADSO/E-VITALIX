            ...
            <div class="col-lg-10 col-md-9 main-content">
                ...
                <div id="consultoriosSection" style="display: block;">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <?php if ($usuario['estado'] === 'Activo'): ?>
                                                    <span class="status-badge bg-primary text-white"><?= $usuario['estado'] ?></span>
                                                <?php else: ?>
                    ...
                    <!-- PAGINACIÓN: visible tanto en escritorio (tabla) como en móvil (tarjetas).
                         Antes vivía solo dentro del bloque "d-lg-none", por lo que en escritorio
                         no existía ninguna forma de pedir la página 2, 3, etc. al servidor. -->
                    <?php if (!empty($usuarios) && isset($total_paginas) && $total_paginas > 1) : ?>
