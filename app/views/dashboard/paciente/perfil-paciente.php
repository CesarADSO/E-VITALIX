                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class=" cont-form-foto bg-white rounded shadow-sm p-4 text-center mb-4">
                                ...
                                <form class="form-foto" action="<?= BASE_URL ?>/paciente/guardar-foto-perfil" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="bg-white rounded shadow-sm p-4">
                                ...
                                <div style="font-size: 14px; margin-bottom: 10px;">
                                    <span style="color: var(--gris-proyecto);">Nombres:</span> <span
                                        style="color: var(--color-primario);"><?= $perfil['paciente_nombre'] ?>, <?= $perfil['apellidos'] ?></span>
                                </div>
                                <div style="font-size: 14px; margin-bottom: 10px;">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="bg-white rounded shadow-sm p-4 mb-4">
                                ...
                                <form action="<?= BASE_URL ?>/paciente/guardar-configuracion-usuario" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="<?= $perfil['id'] ?>">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="nombres" class="form-control campos-formulario" id="nombresInput"
                                                placeholder="Pepito Rodrick ..." value="<?= $perfil['paciente_nombre'] ?>">
                                        </div>
                                        <div class="col-md-6">
                                            <label
                            ...
                            <div class="bg-white rounded shadow-sm p-4">
                                ...
                                <form action="<?= BASE_URL ?>/paciente/cambiar-contrasena" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="<?= $perfil['id'] ?>">
