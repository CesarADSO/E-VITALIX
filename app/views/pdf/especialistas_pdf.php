...
<body>
    ...
    <!-- TÍTULO -->
    <h1>Reporte de especialistas suscritos a la plataforma</h1>

    <!-- DESCRIPCIÓN -->
    <p class="descripcion">
        El presente reporte contiene el listado de los especialistas actualmente suscritos a la plataforma E-VITALIX.
        Este documento permite llevar un control administrativo detallado, facilitando la gestión, auditoría
        y supervisión de la información asociada a cada especialista, incluyendo datos de contacto y ubicación.
    </p>
